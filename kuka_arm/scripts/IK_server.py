...
class ForwardKinematicsSolver:
    ...
    def __init__(self):
        ...
        #########################################################################################
        if os.path.exists(os.path.join(output_dir, "T0_3.p")) and os.path.exists(os.path.join(output_dir, "T0_7.p")):
            T0_3 = pickle.load(open(os.path.join(output_dir, "T0_3.p"), "rb"))
            T0_7 = pickle.load(open(os.path.join(output_dir, "T0_7.p"), "rb"))
        else:
            # @formatter:off
            ...
            # Save
            pickle.dump(T0_3, open(os.path.join(output_dir, "T0_3.p"), "wb"))
            pickle.dump(T0_7, open(os.path.join(output_dir, "T0_7.p"), "wb"))
        ...
        if os.path.exists(os.path.join(output_dir, "R0_7.p")):
            R0_7 = pickle.load(open(os.path.join(output_dir, "R0_7.p"), "rb"))
        else:
            # @formatter:off
            # Rotation about X
            R_X = Matrix([[          1,           0,          0],
            ...
            # Save
            pickle.dump(R0_7, open(os.path.join(output_dir, "R0_7.p"), "wb"))

        #########################################################################################
        # Apply corrections due to gripper link coordinate frame has different definition
        # in URDF file and DH parameters
        #########################################################################################
        if os.path.exists(os.path.join(output_dir, "T_correction.p")) and \
                os.path.exists(os.path.join(output_dir, "R_correction.p")):
            T_correction = pickle.load(open(os.path.join(output_dir, "T_correction.p"), "rb"))
            R_correction = pickle.load(open(os.path.join(output_dir, "R_correction.p"), "rb"))
        else:
            # @formatter:off
            ...
            # Save
            pickle.dump(T_correction, open(os.path.join(output_dir, "T_correction.p"), "wb"))
            pickle.dump(R_correction, open(os.path.join(output_dir, "R_correction.p"), "wb"))

        # Apply correction term
        if os.path.exists(os.path.join(output_dir, "T0_7_corrected.p")) and \
                os.path.exists(os.path.join(output_dir, "T0_7_corrected.p")):
            T0_7_corrected = pickle.load(open(os.path.join(output_dir, "T0_7_corrected.p"), "rb"))
            R0_7_corrected = pickle.load(open(os.path.join(output_dir, "R0_7_corrected.p"), "rb"))
        else:
            T0_7_corrected = simplify(T0_7 * T_correction)
            R0_7_corrected = simplify(R0_7 * R_correction)

            # Save
            pickle.dump(T0_7_corrected, open(os.path.join(output_dir, "T0_7_corrected.p"), "wb"))
            pickle.dump(R0_7_corrected, open(os.path.join(output_dir, "R0_7_corrected.p"), "wb"))
